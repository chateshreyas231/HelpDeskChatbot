...
export default function EPantherForm(): JSX.Element {
  const [epanther, setePanther] = useState<string>();
  const [userDetails, setUserDetails] = useState<any>("");

  const getdetails = (value: any) => {
    console.log(epanther);
    const baseURL = "http://127.0.0.1:5000/get?epanther=" + epanther;
